    ...
    return (
        <div className="p-5 bg-white rounded-lg shadow-sm">
            ...
            <div className="flex items-center p-4 rounded-lg bg-slate-50">
                ...
                <div className="flex flex-col ml-4">
                    <div className="flex items-center gap-2 text-lg font-bold">
                        {name} {family}
                        {(satisfaction > 90 && commentsCount >= 100 && waitingTime === 1) && <TrustIcon/>}
                    </div>
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
                <div
                    className="flex items-center gap-1 p-1 px-3 text-sm font-semibold text-white bg-green-600 rounded-full">
                    <LikeIcon/>
                    {satisfaction}%
                </div>
